...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT_EQ,
                    KC_NO,   KC_LALT, KC_LGUI, LOWER,KC_SPC,   KC_ENT,   RAISE,   KC_RGUI, KC_BSPC, KC_MUTE
),
...
[_LOWER] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_QUES, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX, KC_LT,   KC_GT,   KC_QUES, KC_PLUS,
                    KC_NO,   _______, _______, _______, _______, _______, _______, _______, KC_DEL,  KC_MUTE
),
...
/* SYSTEM
 * ,------------------------------------------.   ___              .-----------------------------------------.
 * |QK_BOOT|QK_RBT|EE_CLR|      |      |PrnScr|  | O |       ___   |NumLck|  7   |  8   |  9   |  -   |ScrLK |
 * |-------+------+------+------+------+------|  | L |      /   \  |------+------+------+------+------+------|
...
// NK_TOGG = Toggle USB N-key rollover (for better BIOS compatibility)
  ...
  [_SYSTEM] = LAYOUT(
  QK_BOOT, QK_RBT,  EE_CLR,  XXXXXXX, XXXXXXX, KC_PSCR,                   KC_NUM,  KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_SCRL,
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_P0,   KC_P0,   KC_PDOT, KC_PSLS, KC_PEQL,
                    KC_NO,   _______, _______, _______, _______, KC_PENT, _______, _______, KC_BSPC, KC_MUTE
  )
};
